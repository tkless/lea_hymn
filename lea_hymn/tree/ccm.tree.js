...
(() => {
  const component = {
    ...
    config: {
      ...
      icon: {
        close: "https://hymn.inf.h-brs.de/tree/resources/img/expand.svg",
        open: "https://hymn.inf.h-brs.de/tree/resources/img/caret-right-fill.svg",
      },
      ...
      css: [
        ...
        "https://hymn.inf.h-brs.de/tree/resources/style.css",
      ],
      dark: false,
      //noActive: true,
    },
