...
export function main(app) {
          ...
          >
            ...
            >
              ...
              >
                ...
                <span class="tool-tip-text-hover">Zurück zu Erzählstrang</span>
              </button>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  ></span>
                  <span class="tool-tip-text-hover">Text größer/kleiner</span>
                </button>
              ...
              >
                ...
                <span class="tool-tip-text">Kopiert!</span>
                <span class="tool-tip-text-hover">Teilen</span>
              </button>
              ...
              >
                ...
                <span class="tool-tip-text-hover">Drucken</span>
              </button>
            </div>
          </div>
        </section>
        <section id="hymn-content" class="mt-4"></section>
        <section id="active-novel">${activeNovel(app)}</section>
      </div>
    </div>
  `;
  function treeView(app) {
    return html` <div data-sidenav id="tree-sidenav" class="sidenav">
  ...
  function containerView() {
    return html` <div data-sidenav id="container-sidenav" class="sidenav">
      <a
        href=""
        class="close-btn"
  ...
  function settings() {
    return html`
      <div data-sidenav id="settings-sidenav" class="sidenav">
        <a
          href=""
          class="close-btn"
        ...
        <div class="m-2 border-start border-end border-bottom p-4 mt-0">
          <h5 class="border-bottom p-1 mb-2">Erzählstrang</h5>
          ${renderPathSelecterbox(app)}

          <h5 class="border-bottom p-1 mb-2">Ansicht</h5>
          ...
          <h5 class="border-bottom mb-3 p-1">Inhalte Filtern</h5>
    ...
    return html`
      <div class="btn-group btn-group-sm mb-1" role="group">
        ...
        >
          ...
          <span class="tool-tip-text-hover">Einklappen</span>
        </button>
        <button
          id="expand-all"
          class="btn btn-light border tool-tip tool-tip-btn"
        ...
        >
          ...
          <span class="tool-tip-text-hover">Ausklappen</span>
        </button>
      </div>
    `;
  }
